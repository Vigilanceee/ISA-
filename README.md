...
The validated Hybrid and Physical checkpoints are hosted separately from the
source repository:
...
[`results/current/cifar100_small_flash_current/`](results/current/cifar100_small_flash_current/).
